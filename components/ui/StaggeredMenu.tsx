...
export interface StaggeredMenuProps {
    ...
    className?: string;
    logoUrl?: string; // We'll ignore this and use custom logo logic if needed for consistency
...
const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
    position = 'right',
    colors = ['#0a0a0a', '#1a1a1a'], // Default to theme dark colors
    items = [],
    socialItems = [],
    displaySocials = true,
    ...
    return (
        ...
        >
            <div
                className={(className ? className + ' ' : '') + 'staggered-menu-wrapper relative w-full h-full z-[9999] pointer-events-none'}
            ...
            >
                ...
                >
                    <div className="sm-logo flex items-center select-none pointer-events-auto" aria-label="Logo">
                        {/* Custom Logo for Vishnu Portfolio */}
                                    ...
                                    <li className="sm-panel-itemWrap relative overflow-hidden leading-none" key={it.label + idx}>
                                        <Link
                                            ...
                                            onClick={() => {
                                                ...
                                                closeMenu(); // Auto close on link click
                                            }}
                                        >
                                            <span className="sm-panel-itemLabel inline-block [transform-origin:50%_100%] will-change-transform font-display">
                                                {it.label}
                                            </span>
                                        </Link>
                                    </li>
